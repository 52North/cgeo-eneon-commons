  ...
  <div class="container">
    ...
    <?php endif; ?>
        ...
        <div class="clear"></div>
            ...
            <?php if ($page['header']) : ?>
              ...
              if (module_exists('i18n_menu')) {
                $main_menu = i18n_menu_translated_tree(variable_get('menu_main_links_source', 'main-menu'));
                $user_menu = i18n_menu_translated_tree(variable_get('menu_user_links_source', 'user-menu'));
                $main_menu_tree = array_merge($main_menu, $user_menu);
              } else {
                $main_menu = menu_tree(variable_get('menu_main_links_source', 'main-menu'));
                $user_menu = menu_tree(variable_get('menu_user_links_source', 'user-menu'));
                $main_menu_tree = array_merge($main_menu, $user_menu);
              }
              ?>
              <div class="content">
        ...
        <?php } ?>
            ...
            <div id="main">
                ...
                <?php if ($page['highlighted']): ?><div id="highlighted"
                                class="clearfix"><?php print render($page['highlighted']); ?></div><?php endif; ?>
        ...
        <?php endif; ?>
                ...
                <?php endif;?>
                Ported to Drupal for the Open Source Community by <a
                                    href="http://www.drupalizing.com"
                                    target="_blank">Drupalizing</a>, a
                                Project of <a
                                    href="http://www.morethanthemes.com"
                                    target="_blank">More than (just)
                                    Themes</a>. Original design by <a
                                    href="http://www.simplethemes.com/"
                                    target="_blank">Simple Themes</a>.
                            </div>
                        </div>
                    </div>
                </div>
